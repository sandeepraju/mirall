...
{
    //srp_ added
    mirallWallet = new Wallet();
    qDebug() << "MirallConfigFile Constructor called!";
}
...
{
    //srp_ added
    mirallWallet->writePassword(passwd);
